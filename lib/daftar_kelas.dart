  ...
  class _DaftarKelasPageState extends State<DaftarKelasPage> {
    ...
    Future<void> _fetchAllData() async {
      try {
        ...
        setState(() {
          ...
          _prodiList = (results[1] as Map<String, dynamic>)['prodiList'] as List<Prodi>;
          _tahunAkademikList = (results[1] as Map<String, dynamic>)['tahunAkademikList'] as List<TahunAkademik>;
          _isLoading = false;
        });
      } catch (e) {
        setState(() {
    ...
    String _getNamaTahunAkademik(String idTahunAkademik) {
      final tahunAkademik = _tahunAkademikList.firstWhere(
        ...
        orElse: () => TahunAkademik(idThnAk: '', namaThnAk: 'Tahun akademik tidak ditemukan'),
      );
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(top: 20.0, bottom: 20.0, right: 20.0, left: 40.0),
                            child: Column(
