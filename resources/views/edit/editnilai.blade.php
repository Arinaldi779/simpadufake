    ...
    <div class="container">
        <div class="form-akademik">
            ...
            <div class="form-actions">
                <a href="{{ route('nilai') }}" class="btn-simpan" style="text-decoration: none; display: inline-block;">Simpan Perubahan</a>
                <a href="{{ route('nilai') }}" class="btn-batal" style="text-decoration: none; display: inline-block;">Batalkan</a>
            </div>
        </div>
