    ...
    <div class="container">
        <div class="form-akademik">
            ...
            <div class="form-group filter-group">
                ...
                <label for="jam-selesai" class="label-selesai">Jam Selesai:</label>
                <input type="time" id="jam-selesai" name="jam-selesai">
            </div>

            <div class="form-actions">
                <a href="{{ route('presensi') }}" class="btn-simpan" style="text-decoration: none; display: inline-block;">Simpan Perubahan</a>
                <a href="{{ route('presensi') }}" class="btn-batal" style="text-decoration: none; display: inline-block;">Batalkan</a>
            </div>
        </div>
