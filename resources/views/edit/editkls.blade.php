    ...
    <div class="container">
        <div class="form-akademik">
            <div class="form-group">
                <label for="status">Nama Kelas</label>
            ...
            <div class="form-actions">
                <a href="{{ route('kelas') }}" class="btn-simpan" style="text-decoration: none; display: inline-block;">Simpan Perubahan</a>
                <a href="{{ route('kelas') }}" class="btn-batal" style="text-decoration: none; display: inline-block;">Batalkan</a>
            </div>
        </div>
