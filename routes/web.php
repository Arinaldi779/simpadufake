...
Route::middleware(['auth', 'roleAccess:Admin Prodi,Super Admin', 'throttle:60,1'])->prefix('prodi')->group(function () {
...
Route::middleware(['auth', 'roleAccess:Admin Akademik,Super Admin', 'throttle:60,1'])->prefix('akademik')->group(function () {
